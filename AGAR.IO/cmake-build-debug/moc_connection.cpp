...
QT_MOC_LITERAL(1, 11, 17), // "newrecievemessage"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 14), // "receivemessage"
QT_MOC_LITERAL(4, 45, 11) // "sendmessage"

    },
    "connection\0newrecievemessage\0\0"
    "receivemessage\0sendmessage"
};
...
void connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newrecievemessage((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&connection::newrecievemessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void connection::newrecievemessage(QString _t1)
{
