...
QT_MOC_LITERAL(3, 26, 13), // "QHostAddress*"
QT_MOC_LITERAL(4, 40, 8), // "QString*"
QT_MOC_LITERAL(5, 49, 2), // "AI"
QT_MOC_LITERAL(6, 52, 12) // "requestlogin"

    },
    "loginmenu\0loginrequested\0\0QHostAddress*\0"
    "QString*\0AI\0requestlogin"
};
...
void loginmenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loginrequested((*reinterpret_cast< QHostAddress*(*)>(_a[1])),(*reinterpret_cast< quint16(*)>(_a[2])),(*reinterpret_cast< QString*(*)>(_a[3]))); break;
        case 1: _t->AI((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (loginmenu::*_t)(QHostAddress * , quint16 , QString * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&loginmenu::loginrequested)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (loginmenu::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&loginmenu::AI)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void loginmenu::loginrequested(QHostAddress * _t1, quint16 _t2, QString * _t3)
{
